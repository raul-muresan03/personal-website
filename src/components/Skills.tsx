...
const skills = [
    ...
    { name: "SQL", experience: "2", level: "Intermediate", Icon: FaDatabase },
    { name: "MATLAB", experience: "2", level: "Intermediate", Icon: PiMathOperationsFill },
    ...
    { name: "Tailwind CSS", experience: "2", level: "Intermediate", Icon: SiTailwindcss },
